...
SWIFT_CLASS("_TtC4MSAL26MSALNativeAuthGenericError")
@interface MSALNativeAuthGenericError : MSALNativeAuthError
/// Describes why an error occurred and provides more information about the error.
@property (nonatomic, readonly, copy) NSString * _Nullable errorDescription;
...
@interface AttributesRequiredError : MSALNativeAuthGenericError
@end
...
/// \param authMethod The authentication method you want to use for sending the challenge
///
/// \param delegate Delegate that receives callbacks for the operation.
///
- (void)requestChallengeWithAuthMethod:(MSALAuthMethod * _Nonnull)authMethod delegate:(id <MFARequestChallengeDelegate> _Nonnull)delegate;
@end
...
/// Describes why an error occurred and provides more information about the error.
@property (nonatomic, readonly, copy) NSString * _Nullable errorDescription;
/// Returns <code>true</code> when the strong authentication method selected has been blocked. Reach out to customer support  to seek assistance.
@property (nonatomic, readonly) BOOL isAuthMethodBlocked;
/// Returns <code>true</code> if a browser is required to continue the operation.
@property (nonatomic, readonly) BOOL isBrowserRequired;
@end
...
SWIFT_CLASS("_TtC4MSAL43MSALNativeAuthChallengeAuthMethodParameters")
@interface MSALNativeAuthChallengeAuthMethodParameters : NSObject
/// Authentication method to challenge.
@property (nonatomic, readonly, strong) MSALAuthMethod * _Nonnull authMethod;
/// Email to contact to register a new strong authentication method.
@property (nonatomic, readonly, copy) NSString * _Nonnull verificationContact;
- (nonnull instancetype)initWithAuthMethod:(MSALAuthMethod * _Nonnull)authMethod verificationContact:(NSString * _Nonnull)verificationContact OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Returns <code>true</code> if the channel is SMS.
@property (nonatomic, readonly) BOOL isSMSType;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) BOOL returnRefreshToken;
...
@class MSALNativeAuthPublicClientApplicationConfig;
...
/// \param nativeAuthConfiguration Configuration for native auth PublicClientApplication
///
///
/// throws:
/// An error that occurred creating the application object
- (nullable instancetype)initWithNativeAuthConfiguration:(MSALNativeAuthPublicClientApplicationConfig * _Nonnull)nativeAuthConfiguration error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
...
///
/// \param challengeTypes The set of challenge types that this application can support as an <code>MSALNativeAuthChallengeTypes</code> optionset
///
///
/// throws:
/// An error that occurred creating the application object
- (nullable instancetype)initWithConfiguration:(MSALPublicClientApplicationConfig * _Nonnull)config challengeTypes:(MSALNativeAuthChallengeTypes)challengeTypes error:(NSError * _Nullable * _Nullable)error SWIFT_DEPRECATED_MSG("Use init(nativeAuthConfiguration: ) instead.");
...
/// throws:
/// An error that occurred creating the application object
- (nullable instancetype)initWithClientId:(NSString * _Nonnull)clientId tenantSubdomain:(NSString * _Nonnull)tenantSubdomain challengeTypes:(MSALNativeAuthChallengeTypes)challengeTypes redirectUri:(NSString * _Nullable)redirectUri error:(NSError * _Nullable * _Nullable)error SWIFT_DEPRECATED_MSG("Use init(nativeAuthConfiguration: ) instead.");
...
@protocol MSALNativeAuthRequestInterceptor;
@class MSALAuthority;
SWIFT_CLASS("_TtC4MSAL43MSALNativeAuthPublicClientApplicationConfig")
@interface MSALNativeAuthPublicClientApplicationConfig : MSALPublicClientApplicationConfig
/// The set of capabilities that this application can support as an <code>MSALNativeAuthCapabilities</code> optionset
@property (nonatomic) MSALNativeAuthCapabilities capabilities;
...
/// Refer to <code>MSALNativeAuthRequestInterceptor</code> for more details.
@property (nonatomic, strong) id <MSALNativeAuthRequestInterceptor> _Nullable requestInterceptor;
...
/// \param challengeTypes The set of challenge types that this application can support as an <code>MSALNativeAuthChallengeTypes</code> optionset
///
- (nonnull instancetype)initWithClientId:(NSString * _Nonnull)clientId authority:(MSALAuthority * _Nonnull)authority challengeTypes:(MSALNativeAuthChallengeTypes)challengeTypes OBJC_DESIGNATED_INITIALIZER;
/// Initialize a MSALNativeAuthPublicClientApplicationConfig.
/// \param clientId The client ID of the application, this should come from the app developer portal.
///
/// \param tenantSubdomain The subdomain of the tenant, this should come from the app developer portal.
...
/// throws:
/// An error that occurred creating the application object
- (nullable instancetype)initWithClientId:(NSString * _Nonnull)clientId tenantSubdomain:(NSString * _Nonnull)tenantSubdomain challengeTypes:(MSALNativeAuthChallengeTypes)challengeTypes error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithClientId:(NSString * _Nonnull)clientId SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithClientId:(NSString * _Nonnull)clientId redirectUri:(NSString * _Nullable)redirectUri authority:(MSALAuthority * _Nullable)authority SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithClientId:(NSString * _Nonnull)clientId redirectUri:(NSString * _Nullable)redirectUri authority:(MSALAuthority * _Nullable)authority nestedAuthBrokerClientId:(NSString * _Nullable)nestedAuthBrokerClientId nestedAuthBrokerRedirectUri:(NSString * _Nullable)nestedAuthBrokerRedirectUri SWIFT_UNAVAILABLE;
@end

@class RegisterStrongAuthVerificationRequiredState;
SWIFT_CLASS("_TtC4MSAL58MSALNativeAuthRegisterStrongAuthVerificationRequiredResult")
@interface MSALNativeAuthRegisterStrongAuthVerificationRequiredResult : NSObject
/// An object representing the new state of the flow with follow on methods.
@property (nonatomic, readonly, strong) RegisterStrongAuthVerificationRequiredState * _Nonnull newState;
/// The email/phone number that the code was sent to.
@property (nonatomic, readonly, copy) NSString * _Nonnull sentTo;
/// The channel (email/phone) the code was sent through.
@property (nonatomic, readonly, strong) MSALNativeAuthChannelType * _Nonnull channelTargetType;
...
@class NSURL;
SWIFT_PROTOCOL("_TtP4MSAL32MSALNativeAuthRequestInterceptor_")
@protocol MSALNativeAuthRequestInterceptor <NSObject>
/// Called before each native auth network request, allowing you to inject custom HTTP header fields.
/// important:
/// <code>completionBlock</code> <em>must always be called</em>, regardless of whether additional headers are needed.
/// <ul>
///   <li>
///     If no additional headers are required, call <code>completionBlock(nil)</code>.
///   </li>
///   <li>
///     If additional headers are needed, inspect <code>requestUrl</code> to determine the request path and
///     call <code>completionBlock</code> with a <code>[String: String]</code> dictionary of headers to inject.
///   </li>
/// </ul>
/// note:
/// All custom header field names must start with the <code>"x-"</code> prefix.
/// The prefixes <code>"x-ms-"</code>, <code>"x-client-"</code>, <code>"x-broker-"</code>, and <code>"x-app-"</code> are reserved and must not be used.
/// \param requestUrl The URL of the outgoing request. Use this to conditionally apply headers per endpoint.
///
/// \param completionBlock Must be called with a header dictionary, or <code>nil</code> if no extra headers are needed.
///
- (void)addAdditionalHeaderFields:(NSURL * _Nullable)requestUrl completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, NSString *> * _Nullable))completionBlock;
@end
...
/// The Refresh Token. This will be nil unless <code>returnRefreshToken</code> was set to true
/// in <code>MSALNativeAuthGetAccessTokenParameters</code> when requesting this token.
...
SWIFT_CLASS("_TtC4MSAL27RegisterStrongAuthBaseState")
@interface RegisterStrongAuthBaseState : MSALNativeAuthBaseState
@end

@class RegisterStrongAuthChallengeError;
@class RegisterStrongAuthState;
SWIFT_PROTOCOL("_TtP4MSAL35RegisterStrongAuthChallengeDelegate_")
@protocol RegisterStrongAuthChallengeDelegate
/// Notifies the delegate that the operation resulted in an error.
/// \param error An error object indicating why the operation failed.
///
/// \param newState An object representing the new state of the flow with follow on methods.
///
- (void)onRegisterStrongAuthChallengeErrorWithError:(RegisterStrongAuthChallengeError * _Nonnull)error newState:(RegisterStrongAuthState * _Nullable)newState;
@optional
/// Notifies the delegate that a verification is required from the user to continue.
/// note:
/// If a flow requires this optional method and it is not implemented,
/// then <code>onSignInRegisterStrongAuthChallengeError(error::newState:)</code> will be called.
/// <ul>
///   <li>
///     Parameter: result: An object representing the new state of the flow with follow on methods.
///   </li>
/// </ul>
- (void)onRegisterStrongAuthVerificationRequiredWithResult:(MSALNativeAuthRegisterStrongAuthVerificationRequiredResult * _Nonnull)result;
/// Notifies the delegate that the sign in operation completed successfully.
/// note:
/// If a flow requires this optional method and it is not implemented,
/// then <code>onSignInRegisterStrongAuthChallengeError(error:newState:)</code> will be called.
...
SWIFT_CLASS("_TtC4MSAL32RegisterStrongAuthChallengeError")
@interface RegisterStrongAuthChallengeError : MSALNativeAuthError
/// Describes why an error occurred and provides more information about the error.
@property (nonatomic, readonly, copy) NSString * _Nullable errorDescription;
/// Returns <code>true</code> when the input introduced is not valid.
@property (nonatomic, readonly) BOOL isInvalidInput;
/// Returns <code>true</code> if a browser is required to continue the operation.
@property (nonatomic, readonly) BOOL isBrowserRequired;
/// Returns <code>true</code> when the verification contact provided has been blocked. Try using another email or phone number, or select an alternative authentication method.
@property (nonatomic, readonly) BOOL isVerificationContactBlocked;
@end

/// An object of this type is created whenever a user needs to register a new strong authentication method.
SWIFT_CLASS("_TtC4MSAL23RegisterStrongAuthState")
@interface RegisterStrongAuthState : RegisterStrongAuthBaseState
/// Requests the server to send the challenge to the default authentication method.
/// <ul>
///   <li>
///     Parameters:
...
///   </li>
/// </ul>
- (void)challengeAuthMethodWithParameters:(MSALNativeAuthChallengeAuthMethodParameters * _Nonnull)parameters delegate:(id <RegisterStrongAuthChallengeDelegate> _Nonnull)delegate;
@end

@class RegisterStrongAuthSubmitChallengeError;
SWIFT_PROTOCOL("_TtP4MSAL41RegisterStrongAuthSubmitChallengeDelegate_")
@protocol RegisterStrongAuthSubmitChallengeDelegate
/// Notifies the delegate that the operation resulted in an error.
/// \param error An error object indicating why the operation failed.
///
/// \param newState An object representing the new state of the flow with follow on methods.
///
- (void)onRegisterStrongAuthSubmitChallengeErrorWithError:(RegisterStrongAuthSubmitChallengeError * _Nonnull)error newState:(RegisterStrongAuthVerificationRequiredState * _Nullable)newState;
@optional
/// Notifies the delegate that the sign in operation completed successfully.
/// note:
/// If a flow requires this optional method and it is not implemented,
...
SWIFT_CLASS("_TtC4MSAL38RegisterStrongAuthSubmitChallengeError")
@interface RegisterStrongAuthSubmitChallengeError : MSALNativeAuthError
/// Describes why an error occurred and provides more information about the error.
@property (nonatomic, readonly, copy) NSString * _Nullable errorDescription;
/// Returns <code>true</code> when the challenge introduced is not valid.
@property (nonatomic, readonly) BOOL isInvalidChallenge;
...
SWIFT_CLASS("_TtC4MSAL43RegisterStrongAuthVerificationRequiredState")
@interface RegisterStrongAuthVerificationRequiredState : RegisterStrongAuthBaseState
...
///   </li>
/// </ul>
- (void)submitChallengeWithChallenge:(NSString * _Nonnull)challenge delegate:(id <RegisterStrongAuthSubmitChallengeDelegate> _Nonnull)delegate;
/// Requests the server to send the challenge to the default authentication method.
/// <ul>
///   <li>
///     Parameters:
...
@interface ResendCodeError : MSALNativeAuthGenericError
@end
...
/// note:
/// If a flow requires this optional method and it is not implemented,
/// then <code>onResetPasswordRequiredError(error:newState:)</code> will be called.
/// \param newState An object representing the new state of the flow with follow on methods.
///
...
/// note:
/// If a flow requires this optional method and it is not implemented,
/// then <code>onResetPasswordResendCodeError(error:newState:)</code> will be called.
/// \param newState An object representing the new state of the flow with follow on methods.
///
/// \param sentTo The email/phone number that the code was sent to.
///
...
/// note:
/// If a flow requires this optional method and it is not implemented,
/// then <code>onResetPasswordVerifyCodeError(error:newState:)</code> will be called.
/// \param newState An object representing the new state of the flow with follow on methods.
///
...
/// \param authMethods The list of available authentication methods for registration.
///
/// \param newState An object representing the new state of the flow with follow on methods.
///
- (void)onSignInStrongAuthMethodRegistrationWithAuthMethods:(NSArray<MSALAuthMethod *> * _Nonnull)authMethods newState:(RegisterStrongAuthState * _Nonnull)newState;
/// Notifies the delegate that a multi factor authentication (MFA) is required from the user to continue.
/// note:
/// If a flow requires this optional method and it is not implemented, then <code>onSignInAfterResetPasswordError(error:)</code> will be called.
/// \param authMethods The list of available authentication methods for MFA.
///
/// \param newState An object representing the new state of the flow with follow on methods.
///
- (void)onSignInAwaitingMFAWithAuthMethods:(NSArray<MSALAuthMethod *> * _Nonnull)authMethods newState:(AwaitingMFAState * _Nonnull)newState;
/// Notifies the delegate that the sign in operation completed successfully.
/// note:
/// If a flow requires this optional method and it is not implemented, then <code>onSignInAfterResetPasswordError(error:)</code> will be called.
/// \param result An object representing the signed in user account.
...
@interface SignInAfterResetPasswordError : MSALNativeAuthGenericError
@end
...
@interface SignInAfterSignUpError : MSALNativeAuthGenericError
@end
...
/// Notifies the delegate that a multi factor authentication (MFA) is required from the user to continue.
/// note:
/// If a flow requires this optional method and it is not implemented, then <code>onSignInVerifyCodeError(error:)</code> will be called.
/// \param authMethods The list of available authentication methods for MFA.
///
/// \param newState An object representing the new state of the flow with follow on methods.
///
